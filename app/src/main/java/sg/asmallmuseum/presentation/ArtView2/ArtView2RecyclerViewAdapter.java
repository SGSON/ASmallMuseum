...
public class ArtView2RecyclerViewAdapter extends RecyclerView.Adapter<ArtView2RecyclerViewAdapter.ArtView2ViewHolder> {
    private List<String[]> mList;

    public ArtView2RecyclerViewAdapter(){
        mList = new ArrayList<>();
    }
